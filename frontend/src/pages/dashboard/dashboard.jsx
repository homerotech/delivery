    ...
    render(){
        return(
            <div>
                ...
                <a className="btn-success btn" href="/cadastroDeCardapio/true">Alterar Cardapio</a>
                <br/>
                <a className="btn-success btn" href="/cadastroDeProdutos">Cadastrar ou alterar produto</a>
                <br/>
